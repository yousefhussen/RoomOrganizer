...
class RoomEnv(Env):
    ...
    def __init__(self,keywords,WallRects,FurnitureRects):
        # Actions we can up, down, right, left
        self.action_space = Discrete(4)
        # Room Dimensions
        self.turn = 0
        self.RoomDimension = (1000, 1000)
        ...
        self.offsetX=abs(min([elem.topleft[0] for elem in self.WallRects]))
        self.offsetZ=abs(min([elem.topleft[1] for elem in self.WallRects]))
        print("offsetsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss",self.offsetX,self.offsetZ)
        # same for windows
